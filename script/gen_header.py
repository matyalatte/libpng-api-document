# Script to generate libpng-api-document.h
# Usage:
#   1. Clone libpng.git into the same directory as generate.py
#   2. Run "python gen_header.py" (requires python 3.10 or later)
#   3. It generates "libpng-api-document-generated.h" in the same directory as gen_header.py
...
class HeaderGenerator:
    ...
    def write_document_h(self, basepath, outpath):
...
if __name__ == "__main__":
    ...
    generator.write_document_h(base_h, generated_h)
    print("done!")
